...
std::pair<int, int> RunCOFF(functionTable* funcTable, char* functionname, unsigned char* coff_data, uint32_t filesize, unsigned char* argumentdata, int argumentSize, uint32_t task_id);
#endif